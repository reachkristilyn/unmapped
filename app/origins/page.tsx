  ...
  return (
    <main id="main" className="min-h-screen bg-emerald-950 text-white px-6 pt-28 pb-20">
      <article className="mx-auto max-w-2xl">
        ...
        them for me in the first place. I mostly just explore and write them down.
        </p>
        <p className="mt-4 text-lg leading-relaxed text-emerald-50">
        The goal is to help turn overlooked gaps into better design.
        </p>
        ...
        infinitely detailed at every scale, yet generated by repeatedly applying the simple equation 
        z<sub>n+1</sub> = z<sub>n</sub><sup>2</sup> + c. Reflecting the Unmapped: it reveals 
