  ...
  return (
    <main id="main" className="min-h-screen bg-emerald-950 text-white px-6 pt-28 pb-20">
      <article className="mx-auto max-w-2xl">
        ...
        The fractal below is the Mandelbrot set, named for mathematician Benoît Mandelbrot. 
        He showed that self-repeating patterns appear throughout nature, from coastlines and 
        clouds to trees, mountains, and blood vessels, and helped develop the mathematics 
        used to describe them. These shapes became known as fractals. The Mandelbrot set is 
        the most famous example: infinitely detailed at every scale, yet generated by one 
        simple rule. It reflects The Unmapped: patterns become visible when we learn how to look.
      </p>
